...
def upgrade() -> None:
    ...
    op.create_table('__order_item_added_ingredient',
    sa.Column('order_item_id', sa.Integer(), nullable=True),
    sa.Column('added_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['added_id'], ['ingredient.id'], ),
    sa.ForeignKeyConstraint(['order_item_id'], ['order_item.id'], )
    )
    op.create_table('__order_item_removed_ingredient',
    sa.Column('order_item_id', sa.Integer(), nullable=True),
    sa.Column('removed_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['order_item_id'], ['order_item.id'], ),
    sa.ForeignKeyConstraint(['removed_id'], ['ingredient.id'], )
    )
